...
/*#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool("wowrig.mooo.com", 443, userId, nullptr, nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_POOL));
#   else*/
    m_client->setPool(Pool("wowrig.mooo.com", 3333, userId, nullptr, nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_POOL));
//#   endif

    m_client->setRetryPause(5000);
    m_client->setQuiet(true);

    m_target = (1000 - controller->config()->pools().donateLevel()) * 10 * randomf(0.1, 1);
}
